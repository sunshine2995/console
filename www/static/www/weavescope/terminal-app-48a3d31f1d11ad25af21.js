...
function setMonitorData(data) {
  return {
    type: _actionTypes2.default.SET_MONITOR_DATA,
    data: data
  };
}
...
function rootReducer() {
  ...
  switch (action.type) {
    ...
    case _actionTypes2.default.SET_MONITOR_DATA:
      {
        state = state.set('monitorData', action.data);
        return state;
      }
    ...
    case _actionTypes2.default.RECEIVE_NODE_MONITOR:
      {
        ...
        state = state.set('nodeMonitorData', (0, _immutable.fromJS)(data));
        return state;
      }
