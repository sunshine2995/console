...
exports.receiveNodesMonitor = receiveNodesMonitor;
...
function receiveNodesMonitor(monitor) {
  ...
  return function (dispatch, getState) {
    ...
    dispatch({
      type: _actionTypes2.default.RECEIVE_NODE_MONITOR,
      monitor: monitor
    });
  };
}
...
var initialState = exports.initialState = (0, _immutable.Map)({
  ...
  nodeMonitorData: (0, _immutable.OrderedMap)(), // serviceId -> monitorData
  nodesLoaded: false,
...
function rootReducer() {
  ...
  switch (action.type) {
    ...
    case _actionTypes2.default.RECEIVE_NODE_MONITOR:
      {
        var data = action.monitor || {};

        for (var k in data) {
          state = state.setIn(['nodeMonitorData', k], (0, _immutable.fromJS)(action.monitor[k]));
        }
